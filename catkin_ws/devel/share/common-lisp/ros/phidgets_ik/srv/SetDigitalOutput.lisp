...
(cl:defmethod cl:initialize-instance :after ((m <SetDigitalOutput-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetDigitalOutput-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name phidgets_ik-srv:<SetDigitalOutput-request> is deprecated: use phidgets_ik-srv:SetDigitalOutput-request instead.")))

(cl:ensure-generic-function 'index-val :lambda-list '(m))
(cl:defmethod index-val ((m <SetDigitalOutput-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader phidgets_ik-srv:index-val is deprecated.  Use phidgets_ik-srv:index instead.")
  (index m))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <SetDigitalOutput-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader phidgets_ik-srv:state-val is deprecated.  Use phidgets_ik-srv:state instead.")
  (state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetDigitalOutput-request>)))
  ...
  "phidgets_ik/SetDigitalOutputRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDigitalOutput-request)))
  "Returns string type for a service object of type 'SetDigitalOutput-request"
  "phidgets_ik/SetDigitalOutputRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetDigitalOutput-request>)))
  ...
  (cl:format cl:nil "~%~%uint16 index~%bool state~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetDigitalOutput-request)))
  "Returns full string definition for message of type 'SetDigitalOutput-request"
  (cl:format cl:nil "~%~%uint16 index~%bool state~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetDigitalOutput-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetDigitalOutput-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name phidgets_ik-srv:<SetDigitalOutput-response> is deprecated: use phidgets_ik-srv:SetDigitalOutput-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetDigitalOutput-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader phidgets_ik-srv:success-val is deprecated.  Use phidgets_ik-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetDigitalOutput-response>)))
  ...
  "phidgets_ik/SetDigitalOutputResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetDigitalOutput-response)))
  "Returns string type for a service object of type 'SetDigitalOutput-response"
  "phidgets_ik/SetDigitalOutputResponse")
